...
def scrape():
    ...
    data=pd.read_csv("soft-dev.csv")
    #sheet = client.open('Indeed JDs2').sheet1
    #try:
    ...
    with open("softdevjds.csv","a",newline="") as csvfile:
        writer=csv.DictWriter(csvfile,fieldnames=["jobkey","jd"])
        #writer.writeheader()
